...
\hspace*{-3em}\begin{tiny}\begin{prooftree}[separation=0.5em]
\hypo{\Gamma^n\vdash R\in\textbf{RType}^n}
\hypo{\ell\in\mathcal{L}-\mathrm{labels}(R)}
\hypo{\Gamma^n\vdash T_1,\ldots,T_m\in\textbf{Type}^n}
\hypo{\pi_1,...,\pi_m\in\mathrm{paths}(R)}
\hypo{\Gamma^n\vdash\mathcal{T}:(T_1\rightarrow\ldots\rightarrow(T_m\rightarrow\textit{Type}^n)\ldots)}
\infer5{\Gamma^n\vdash
R\cup\{\langle,\langle\mathcal{T},\langle\pi_1,\ldots,\pi_m\rangle\rangle\rangle\}\in\textbf{RType}^n} 
\end{prooftree}
\end{tiny}
