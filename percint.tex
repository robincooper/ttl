...
that if you have a predicate $r$ whose arity is $\langle
T_1,\ldots,T_n\rangle$ and you have objects $a_1:T_1,\ldots,a_n:T_n$
then $r(a_1,\ldots,a_n)$ is a ptype and any ptype is also a type.
...
\item \begin{prooftree}
\hypo{\Gamma\vdash r\in\textbf{Pred}} \hypo{\Gamma\vdash \langle
  T_1,\ldots,T_n\rangle=\textit{Arity}(r)} \hypo{\Gamma\vdash
  a_1:T_1,\ldots,\Gamma\vdash a_n:T_n} \infer3{\Gamma\vdash
  r(a_1,\ldots,a_n)\in\textbf{PType}}
\end{prooftree}
...
\begin{prooftree}
\hypo{\Gamma\vdash r\in\textbf{Pred}} \hypo{\Gamma\vdash \langle
  T_1,\ldots,T_n\rangle\in\textit{Arity}(r)} \hypo{\Gamma\vdash
  a_1:T_1,\ldots,\Gamma\vdash a_n:T_n} \infer3{\Gamma\vdash
  r(a_1,\ldots,a_n)\in\textbf{PType}}
\end{prooftree}
...
@@ [Where to put the set theoretic coding of ptypes?]  
