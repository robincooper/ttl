...
\preveg{} is given in \nexteg{}.  (In a short while we will introduce
a complication in connection with the dependency represented by `hug(x,y)'.)
\begin{ex} 
\begin{subex} 
...
\end{ex} 
`x', `y' and `e' are particular labels.  In record types, the ordered
...
\end{ex} 
\preveg{} means in a context where $x$ and $y$ are
