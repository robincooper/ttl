...
uses the kind of format normally employed in proof theory.  Instead of
regarding contexts, $\Gamma$, as sequences of judgements we will
regard them as structures like those in \preveg{}.  We will write
...
rule \preveg{} has the force of a biconditional.@@   
