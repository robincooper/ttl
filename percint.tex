...
correspondence becomes important below, when we talk about modal type systems.
...
set which is designated as the set of labels.  A \textit{labelled set} is a set
