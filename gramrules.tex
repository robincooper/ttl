...
\smallrecord{\smallmfield{cnt}{SemCommonNoun($p$)}{\textit{Ppty}}}
...
\smallrecord{\smallmfield{cnt}{SemIntransVerb($T_{\mathrm{bg}}$,
    $p$)}{\textit{PPpty}}} 
...
\smallrecord{\smallmfield{cnt}{SemPropName($a$)}{\textit{Quant}}}
...
(Chapter~\ref{ch:commonnouns}) \\
is defined as \\
Lex($T_{\mathrm{phon}}$, \textit{NP}) \d{$\wedge$} \smallrecord{\smallmfield{cnt}{SemNumeral($n$)}{\textit{PQuant}}}
...
\smallrecord{\smallmfield{cnt}{SemIndefArt}{(\textit{Ppty}$\rightarrow$\textit{Quant})}}
...
Lex($T_{\mathrm{Phon}}$,
\textit{V}) \d{$\wedge$}
\smallrecord{\smallmfield{cnt}{SemBe}{(\textit{Quant}$\rightarrow$\textit{Ppty})}} 
...
Lex($T_{\mathrm{Phon}}$,
\textit{V}) \d{$\wedge$}
\smallrecord{\smallmfield{cnt}{SemBe($T_{\mathrm{arg}}$, $T_{\mathrm{bg}}$)}{(\textit{Quant}$\rightarrow$\textit{PPpty})}} 
...
$\lambda T_1$:\textit{Type} $\lambda T_2$:\textit{Type} . \\
\hspace*{1em}$\lambda
u$:\smallrecord{\smalltfield{cnt}{\smallrecord{\smalltfield{bg}{\textit{RecType}}\\
                                               \smalltfield{fg}{(bg$\rightarrow$($T_2\rightarrow T_1$))}}}}$^{\frown}$
   \smallrecord{\smalltfield{cnt}{\smallrecord{\smalltfield{bg}{\textit{RecType}}\\
                                               \smalltfield{fg}{(bg$\rightarrow T_2$)}}}} . \\
\hspace*{2em}\smallrecord{\smallmfield{cnt}{$u$[0].cnt@$u$[1].cnt}{\smallrecord{\smalltfield{bg}{\textit{RecType}}\\
                                                                                \smalltfield{fg}{(bg$\rightarrow T_1$)}}}} 

CntForwardApp (Chapter~\ref{ch:commonnouns})
...
\hspace*{1em}
\textit{VP}\d{$\wedge$}\smallrecord{\smallmfield{cnt}{$u$[2].syn.daughters[2].cnt}{\textit{Ppty}}}
