...
is
\begin{quote}
$\ulcorner\lambda c$: \smallrecord{\smalltfield{x}{\textit{Ind}}\\
                         \smalltfield{e}{named(x, $T$)}} . $\lambda
                       P$:\textit{Ppty} . $P(c)\urcorner$
                     \end{quote}
...
\subsubsection{Constituent structure} (as in Chapter~\ref{ch:gram})
% \begin{description}
...
\subsection{English resources} (as in Chapter~\ref{ch:gram})
