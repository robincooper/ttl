...
\item  $\mathfrak{c}$.f.x $\leadsto$ id$_7$.x\\
     ...
     \item \smallrecord{
         \smalltfield{$\mathfrak{c}$}{\smallrecord{
           \smalltfield{f}{\smallrecord{\smallmfield{x}{$r$.id$_7$.x}{\textit{Ind}}\\
...
p.~\pageref{ex:AccGBfinal}.% Assuming that we have relabellings $\eta$ and $\eta'$
...
We regard these different kinds of
...
\begin{ex} 
$\ulcorner\lambda c$:\smallrecord{\smalltfield{$\mathfrak{s}$}{\smallrecord{\smalltfield{x$_0$}{\textit{Ind}}\\
              \smalltfield{x$_1$}{\textit{Ind}}}}\\
                \smalltfield{$\mathfrak{c}$}{\smallrecord{\smalltfield{x}{\textit{Ind}}\\
              \smalltfield{e}{named(x, ``Sam'')}}}\\
\ldots} . $\varphi\dep{c}\urcorner$ 
\end{ex}
...
\item $\ulcorner\lambda c$:\textit{Cntxt}\d{$\wedge$}\smallrecord{
    \smalltfield{$\mathfrak{s}$}{\smallrecord{
        \smalltfield{x$_0$}{\textit{Ind}}}}} . 
        $\lambda P$:\textit{Ppty} . $P$(\smallrecord{\field{x}{$c.\mathfrak{s}$.x$_0$}})$\urcorner$
 
\item $\ulcorner\lambda c$:\textit{Cntxt} . 
        $\lambda r$:\smallrecord{\smalltfield{x}{\textit{Ind}}} . 
              \record{\tfield{e}{leave($r$.x)}}$\urcorner$

            \item $\ulcorner\lambda c$:\textit{Cntxt}\d{$\wedge$}\smallrecord{
                \smalltfield{$\mathfrak{s}$}{\smallrecord{
                    \smalltfield{x$_0$}{\textit{Ind}}}}}
  . 
         \record{\tfield{e}{leave($c.\mathfrak{s}$.x$_0$)}}$\urcorner$
 
\end{subex} 
\label{ex:he-leave}   
\end{ex}
For the sake of saving space and for readability it will be useful to
introduce the notational convention in \nexteg{} inspired by a similar
notation in Head Driven Phrase Structure Grammar \citep{Sag:Wasow:ea:03}.
\begin{ex} 
  \record{
    \footnotesize{$T$}\\
    \tfield{$\ell_1$}{$T_1$}\\
  ...
  $T$\d{$\wedge$}\record{
    ...
    \tfield{$\ell_n$}{$T_n$}}
\end{ex}
This means, for example, that we can represent (\ref{ex:he-leave}) as
\nexteg{}.
\begin{ex} 
\begin{subex} 
 
\item $\ulcorner\lambda c$:\smallrecord{\footnotesize{\textit{Cntxt}}\\
    \smalltfield{$\mathfrak{s}$}{\smallrecord{
        \smalltfield{x$_0$}{\textit{Ind}}}}} . 
        $\lambda P$:\textit{Ppty} . $P$(\smallrecord{\field{x}{$c.\mathfrak{s}$.x$_0$}})$\urcorner$
...
\begin{ex} 
  $\ulcorner\lambda c$:\smallrecord{
    ...
    \smalltfield{$\mathfrak{s}$}{\smallrecord{
        \smalltfield{x$_0$}{\textit{Ind}}}}} . $\lambda P$:\textit{Ppty} . $P$(\smallrecord{\field{x}{$c.\mathfrak{s}$.x$_0$}})$\urcorner$
\end{ex}
...
We can now modify the combination rule in
...
%         $\lambda P$:\textit{Ppty}
%         . $P$(\smallrecord{\field{x}{$c.\mathfrak{s}$.x$_i$}})$\urcorner$
% \label{ex:pronoun-cont}
% \end{ex}
While each pronoun consider on its own will have a content involving
...
\item $\ulcorner\lambda c$:\smallrecord{
    ...
    \smalltfield{$\mathfrak{s}$}{\smallrecord{
        ...
        \smalltfield{x$_1$}{\textit{Ind}}}}}
                                 . 
\record{\tfield{e}{hug($c.\mathfrak{s}$.x$_0$, $c.\mathfrak{s}$.x$_1$)}}$\urcorner$ 
...
\item  If $T_{\text{bg}}$ is a record type (for context) and $p$ is a
        ...
        \begin{quote}
          ...
          r_1$:\smallrecord{\smalltfield{x}{\textit{Ind}}} . $q(\lambda r_2$:\smallrecord{\smalltfield{x}{\textit{Ind}}}
...
A potential advantage of using record types to characterize pronominal contexts
...
\begin{ex}
  $\ulcorner\lambda c$:\smallrecord{
    ...
    \smalltfield{$\mathfrak{s}$}{\smallrecord{
        ...
        \smalltfield{x$_1$}{\textit{Ind}}}}\\
    \smalltfield{$\mathfrak{c}$}{\smallrecord{
          \smalltfield{c$_0$}{male($\Uparrow\!\!\mathfrak{s}$.x$_0$)}\\
          \smalltfield{c$_1$}{neuter($\Uparrow\!\!\mathfrak{s}$.x$_1$)}}}
}
                                 . 
\record{\tfield{e}{hug($c.\mathfrak{s}$.x$_0$, $c.\mathfrak{s}$.x$_1$)}}$\urcorner$ 
...
\item[\textnormal{\textit{Cntxt}} New!] --- \record{
      \tfield{$\mathfrak{s}$}{\textit{Assgnmnt}}\\
      \tfield{$\mathfrak{c}$}{\textit{PropCntxt}}}
  ...
  \item[\textnormal{\textit{CntxtType}} New!] --- a basic type
    ...
    $T:\textit{CntxtType}$ iff $T\sqsubseteq\textit{Cntxt}$
      ...
      \item[\textnormal{\textit{PPpty}} New!] --- \record{\tfield{bg}{\textit{CntxtType}} \\
        \tfield{fg}{(bg$\rightarrow$\textit{Ppty})}}
        
      \item[\textnormal{\textit{Quant}}] ---
        (\textit{Ppty}$\rightarrow$\textit{RecType})
        
      \item[\textnormal{\textit{PQuant}} New!] --- \record{\tfield{bg}{\textit{CntxtType}} \\
          \tfield{fg}{(bg$\rightarrow$\textit{Quant})}}
