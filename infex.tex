...
to represent the type of non-empty lists of objects of type $T$.
\begin{shaded}
...
\begin{prooftree}
\hypo{s_{i,A}:_A\text{\record{\tfield{agenda}{$\mathrm{nelist}(\textit{RecType})$}}}}
\infer[enth]1{:_A \mathrm{fst}(s_{i,A}.\text{agenda})!}
\end{prooftree} 
\end{ex}
...
relating to signs are given in \nexteg{}.

@@\todo{Should we have already introduced subtyping?}
