...
Note that the functions in \preveg{}, with the exception of the
function listed first, are of the
type \nexteg{}.
\begin{ex}
(($r$:\textit{InfoState})$\rightarrow$($\mathrm{fst}(r.\text{agenda})$$\rightarrow$\textit{RecType}))
\end{ex}
