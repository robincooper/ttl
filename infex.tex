...
resources as topoi in the sense of Breitholtz\todo{reference to
  book}.  Among this collection of functions may be several which
...
of objects of type $T$ and [ ] to represent the empty list.
\begin{ex}
\begin{subex} 
