...
\section{The string theory of events}\todo{Moved from Ch. 1.  In the
...
\begin{shaded}
We can give a formal characterization of strings as in \nexteg{}
(repeated in Appendix~\ref{sec:regular}).
\end{shaded} \todo{Not necessary since we will use records to model strings}@@
...
\section{Doing things with types}\todo{Moved from Ch. 1.  Needs integrating}
\label{sec:typeacts}
