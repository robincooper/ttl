...
notation for $T$ by carrying out in order the manipulations
characterized in \nexteg{}, repeated in Appendix~\ref{app:unique-id}.
\begin{ex}
\begin{enumerate} 
...
\end{enumerate}
\label{ex:official-to-unique-id}
\end{ex}
...
carrying out the manipulations characterized in \nexteg{} in order
(repeated in Appendix~\ref{app:unique-id})
...
\label{ex:unique-id-to-official}
...
Note that the definition of paths for record types
(Chapter~\ref{ch:percint}, p.~\pageref{ex:paths-rectype}) means that
paths in record types will extend into meet types (but not join
types). For example, the record type \nexteg{a} (assuming \textit{Sit} is some
basic type) has the paths \nexteg{b}
\begin{ex}
  \begin{subex}
  \item   \record{
      \tfield{e}{\record{
  ...
  \smallrecord{
    \smalltfield{private}{\smallrecord{
        \smalltfield{agenda}{\smallrecord{
            \smallmfield{fst}{
              \smallrecord{
                \footnotesize{\textit{Acknowledgement}}\\
                \smalltfield{s-event}{\smallrecord{
            ...
            \smalltfield{rst}{\smallrecord{
                ...
                \smalltfield{rst}{\smallrecord{
                    ...
                    \smallmfield{rst}{[ ]}{$\mathrm{list}(\textit{RecType})$}}}}}}}}}\\
    \smalltfield{shared}{\smallrecord{
        \smallmfield{latest-utterance}{$u_1$}{\smallrecord{
            \footnotesize{\textit{Assertion}}\\
            \smalltfield{s-event}{\smallrecord{
                \smallmfield{sp}{$A$}{\textit{Ind}}\\
    ...
    \smalltfield{private}{\smallrecord{
        \smalltfield{agenda}{\smallrecord{
                ...
                \smalltfield{rst}{\smallrecord{
                    ...
                    \smallmfield{rst}{[ ]}{$\mathrm{list}(\textit{RecType})$}}}}}}}\\
    \smalltfield{shared}{\smallrecord{
        \smallmfield{latest-utterance}{$u_2$}{\smallrecord{
            \footnotesize{\textit{Acknowledgement}}\\
            \smalltfield{s-event}{\smallrecord{
                \smallmfield{sp}{$B$}{\textit{Ind}}\\
                \smallmfield{au}{$A$}{\textit{Ind}}}}\\
...
\smallrecord{
    \smalltfield{private}{\smallrecord{
        \smallmfield{agenda}{[ ]}{$\mathrm{list}(\textit{RecType})$}}} \\
    \smalltfield{shared}{\smallrecord{
        \smallmfield{latest-utterance}{$u_6$}{\smallrecord{
            \footnotesize{\textit{Acknowledgement}}\\
              \smalltfield{s-event}{\smallrecord{
                  \smallmfield{sp}{$B$}{\textit{Ind}}\\
                  \smallmfield{au}{$A$}{\textit{Ind}}}} \\
...
\item[\textnormal{\textit{SEvent}}] --- \record{\tfield{e-loc}{\textit{Loc}} \\
    ...
    \item[\textnormal{\textit{Cont}}] --- \textit{RecType}
...
on the notion of judgement which is present in Martin-Löf's type
