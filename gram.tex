...
\begin{ex}
  ...
  \begin{prooftree}
    ...
    \hypo{T_{\text{chart}}\sqsubseteq\text{\smallrecord{
          ...
          \smalltfield{e}{\smallrecord{
              \smalltfield{t$_k$}{start($\Uparrow^2$e$_j$)}\\
              \smalltfield{t$_l$}{end($\Uparrow^2$e$_j$)}}}}}}
    \infer[no rule]1{\hspace*{10em}}
                  ...
                  \smalltfield{e$_{\text{incr}_e(T_{\text{chart}})}$}{Lex$_{\text{PropName}}$($T_{\text{phon}}$,
                    $a$) \d{$\wedge$}\\ \hspace*{3em}\smallrecord{
                      \smalltfield{s-event}{\smallrecord{
                          \smallmfield{e}{$\Uparrow^2$e$_j$}{\textit{Phon}}}}}}\\
                  \smalltfield{e}{\smallrecord{
                      \smalltfield{t$_k$}{start($\Uparrow^2$e$_{\text{incr}_e(T_{\text{chart}})}$)}\\
                      \smalltfield{t$_l$}{end($\Uparrow^2$e$_{\text{incr}_e(T_{\text{chart}})}$)}}}}}}}}}}
    \end{prooftree}
\end{ex} 

@@

For the remaining lexical resources
