...
s$.\label{pg:property-restriction} We take our previous example of the property of being a dog,
...
\item
  \begin{prooftree}
    \hypo{\Gamma,\mathcal{L}\vdash T\in\textbf{Type}-\text{RType}}
    \hypo{\Gamma,\mathcal{L}\vdash r \text{ record}}
    \infer2{\Gamma,\mathcal{L}\vdash
      \rho(T,r)\in\textbf{Type}}
  \end{prooftree}
...
\item
  \begin{prooftree}
    ...
    \infer3{\Gamma,\mathcal{L}\vdash a:\rho(T,r)}
  \end{prooftree}
  
  \begin{prooftree}
    \hypo{\Gamma,\mathcal{L}\vdash a:\rho(T,r)}
...
This is given by the definition in \nexteg{} repeated in Appendix~\ref{app:specrec}.
\begin{ex} 
\begin{subex} 
...
\end{subex} 
\label{ex:restriction-other-objs}   
\end{ex} 
...
$\lambda
u$:\smallrecord{
\footnotesize{\textit{V}}\\
\smalltfield{s-event}{\smallrecord{\smalltfield{e}{``is''}}}}$^{\frown}$\smallrecord{
\footnotesize{\textit{NP}}\\
\smalltfield{syn}{\smallrecord{\smalltfield{daughters}{\smallrecord{
        \footnotesize{\textit{Det}}\\
        \smalltfield{s-event}{\smallrecord{\smalltfield{e}{``a''}}}} 
$^{\frown}$
\smallrecord{
  \footnotesize{\textit{N}}\\
  \smalltfield{cont}{\textit{Ppty}}}}
}}} . \\
\hspace*{4em} \smallrecord{
  \footnotesize{\textit{VP}}\\
  \smallmfield{cont}{$u$[2].syn.daughters[2].cont}{\textit{Ppty}}} 
\end{ex} 
