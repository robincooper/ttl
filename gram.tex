    ...
    \infer[enth]1[\tiny\begin{tabular}{l}$T_{\text{chart}}\not\sqsubseteq$\\\smallrecord{
      ...
      \smalltfield{e}{${T_{\text{evpref}}}^\frown$\\\hspace*{.5em}\smallrecord{
        ...
        {\begin{array}{l} s_{i+1,A}:_A
          T_{\text{infstate}}\text{\fbox{\d{$\wedge$}}}\\\hspace*{1em}\text{\small\smallrecord{
              \smalltfield{shared}{\smallrecord{
...
\begin{prooftree}
    ...
    \infer[enth]1[\tiny\begin{tabular}{l}$T_{\text{chat}}\not\sqsubseteq$\\
                 ...
                 \\
                         ...
                         for any $i$\end{tabular}]{\begin{array}{l}s_{i+1,A}:_A
                         T_{\text{infstate}}
                         \text{\fbox{\d{$\wedge$}}}\\
                         \text{\footnotesize\smallrecord{
                             \smalltfield{shared}{\smallrecord{
                                 \smalltfield{current-utterance}{$T_{\text{chart}}$\d{$\wedge$}\smallrecord{
                                     \smalltfield{e$_f$}{$T_{\mathrm{sign}_1}$} \\
                                     \smalltfield{e$_k$}{\smallrecord{
