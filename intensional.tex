  ...
  $\lambda c$:\smallrecord{
    \smalltfield{$\mathfrak{c}$}{\smallrecord{
        \smalltfield{f}{\smallrecord{
            ...
            \smalltfield{e}{named(x, ``Charlie'')}}}\\
        \smalltfield{a}{\textit{Rec}}}}} . 
\record{\tfield{e}{buy($\mathfrak{c}$.f.x, \textbf{a$^\frown$coat\_like\_Bill's}(c.a))}}
\label{ex:contCbaclB} 
\end{ex} 
...
\begin{ex}
  $\lambda c$:\smallrecord{
    \smalltfield{$\mathfrak{c}$}{\smallrecord{
        ...
        \smalltfield{a}{\textit{Rec}}}}} . 
  \record{
    \tfield{e}{\textbf{a$^\frown$coat\_like\_Bill's}(c.a)($\lambda
      r$:\smallrecord{
        \smalltfield{x}{\textit{Ind}}} . 
        \record{\tfield{e}{buy($\mathfrak{c}$.f.x, $r$.x)}})}}
...
\end{ex}
\preveg{} is \nexteg{} where we have spelled out the contribution of
...
\begin{ex} 
 $\lambda c$:\smallrecord{
  ...
  \record{
    \tfield{e}{\record{
        \mfield{range}{\textbf{coat\_like\_Bill's}($c$.a)}{\textit{Ppty}}\\
        \mfield{scope}{$\lambda r$:\smallrecord{
            \smalltfield{x}{\textit{Ind}}} . \smallrecord{
            \smalltfield{e}{buy($\mathfrak{c}$.f.x,
              $r$.x)}}}{\textit{Ppty}}\\
        \tfield{e}{exist(range, scope)}}}}
\end{ex} 
...
@@\todo{p. 233 needs fixing and then derivation of \textit{Charlie
    wants a jacket like Bill's}}
