...
$e$ : believe($a$, $T$) if\\
\hspace*{2em} $e'$ : believe($a$, $T_1$) for some component $e'$ of $e$\\
\hspace*{2em} $e'$ : pov($T_2$, $T_1$) for some component $e'$ of $e$\\
...
\item $e'$ : rbelieve($a$,$T_1$) for some component $e'$ of $e$

\item $e'$ : pov($T_2$,$T_1$) for some component $e'$ of $e$
...
\item $e'$ : rbelieve($a$,$T$) for some component $e'$ of $e$

\item $e'$ : pov($T'$,$T$) for some component $e'$ of $e$ 
...
\item[with arity
  ...
  \textbf{or} if
  \begin{quote}
    $e'$ : believe($a$, $T_1$) for some component $e'$ of $e$\\
    $e'$ : pov($T_2$, $T_1$) for some component $e'$ of $e$\\
