...
\textit{Type}$\rangle$.  Our first suggestion for witness conditions
...
\begin{ex}
  Witness conditions for `nec' (version 1)
\begin{subex} 
...
\begin{ex}
  Witness conditions for `poss' (version 1)
\begin{subex} 
...
For `poss' we have \nexteg{}.
\begin{ex}
  Witness conditions for `poss' (version 2)
\begin{subex} 
...
and $p\in\mathbb{T}$.
\begin{ex}
  Witness conditions for `nec' (version 3)
\begin{subex} 
...
\nexteg{}.
\begin{ex}
  Witness conditions for `poss' (version 3)
  \begin{subex} 
...
\begin{ex}
  ...
  \item
    \begin{prooftree}
      ...
      \hypo{\tau \text{ resource}_A}
      \hypo{s:_A\tau.\text{bg}}
      \infer[enth]3[oblig]{:_A\tau.\text{fg}(s)!}
    \end{prooftree}
...
$p\in\mathbb{T}$.
\begin{ex}
 Witness conditions for `nec' (version 4) 
\begin{subex} 
...
\end{subex}
\end{ex}
Similarly, for `poss' we have the witness conditions in \nexteg{}.
\begin{ex}
Witness conditions for `poss' (version 4)
  \begin{subex}
 \item  
...
@@ \todo{Are these right for deontic interpretations?}
...
\todo[inline]{Paul Égré in 2014\_Book\_Epistemology..., sem034\_PE}
...
\todo{From here to ``In Section 6.1'' moved from Ch.~\ref{ch:percint}.  Not
  clear where it should go.} A predicate like `believe' which represents that an individual has an
