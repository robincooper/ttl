...
\item If $s:_p\text{nec}(T,B,I)$, then for any $p'\in\mathbb{T}$ if
  for some $a$, $a:_{p'}B$ (i.e. $B$ is ``true'') and for some $a$,
  $a:_{p'}I$ (i.e. $I$ is ``true'') then for some $a$, $a:_{p'}T$
  (i.e. $T$ is ``true'')

  
\item If it is the case that for any $p'\in\mathbb{T}$ if
  for some $a$, $a:_{p'}B$ (i.e. $B$ is ``true'') and for some $a$,
  $a:_{p'}I$ (i.e. $I$ is ``true'') then for some $a$, $a:_{p'}T$
  (i.e. $T$ is ``true''), then
  \begin{quote}
...
possibility just in case for any possibility, $p$, if $B$ and $I$ are
...
necessary that Mary eat her broccoli) just in case
...
@@\todo{Should we require that $B$ is true according to $p$?}
...
eats everything on her plate and a situation in which Mary eats her broccoli.
