...
which we will notate as $T\parallel r$.@@\todo{Refer to
  specification/anchoring on p. 178.  Put this in the appendix?}  \nexteg{} provides an abstract example of how it works. 
\begin{ex} 
...
\subsubsection{Lexicon} (as in Chapter~\ref{ch:propnames})
% \begin{description}
...
\item[Predicates] \mbox{}
  ...
  \item[with arity \textnormal{$\langle\textit{Ind},\textit{Ind}\rangle$}] \{hug\}
  \end{description}
