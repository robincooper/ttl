...
given in \nexteg{}. @@ \todo{Think about \textit{Ppty} and record
  level predicates/properties.}
\begin{ex} 
  $\ulcorner\lambda c$:\smallrecord{
    \smalltfield{$\mathfrak{c}$}{\textit{TempRiseEventCntxt}}} .
  $\lambda r$:\textit{Rec} . \record{
...
\end{quote}
    ...
    \textit{Rec}\rangle$ and $T_{\mathrm{bg}}$ is a type (of context), then
    SemCommonNoun($T_{\mathrm{bg}}$, $p$) is
  \begin{quote}
    $\lambda c$:$T_{\mathrm{bg}}$ . $\lambda
r$:\textit{Rec}
. \record{\tfield{e}{$p$($r$, $c$)}}
\end{quote}
...
\item[\textnormal{Lex$_{\mathrm{CommonNoun}}$($T_{\mathrm{phon}}$,
  ...
  If $T_{\mathrm{phon}}$ is a phonological type, $p$ is a
  predicate with arity $\langle\textit{Rec}, \textit{Rec}\rangle$ and
  $T_{\mathrm{bg}}$ is a type (of context), then
  Lex$_{\mathrm{CommonNoun}}$($T_{\mathrm{phon}}$, $T_{\mathrm{bg}}$,
  $p$) is
  \begin{quote}
...
. \record{\mfield{restr}{$Q$}{\textit{Ppty}} \\
      ...
      \item[\textnormal{Lex$_{\mathrm{IntransVerb}}$($T_{\mathrm{phon}}$,
        ...
        If $T_{\mathrm{phon}}$ is a phonological type,
        $T_{\mathrm{bg}}$ a record type (for context) and $p$ is a
        predicate with arity $\langle\textit{Rec}, \textit{Rec}\rangle$, then Lex$_{\mathrm{IntransVerb}}$($T_{\mathrm{phon}}$,
        $T_{\mathrm{bg}}$, $p$) is
        \begin{quote}
          Lex($T_{\mathrm{phon}}$, \textit{V$_i$}) \d{$\wedge$}
          \smallrecord{\smallmfield{cnt}{SemIntransVerb($T_{\mathrm{bg}}$, $p$)}{\textit{PPpty}}}
...
\item[Predicates] \mbox{}
  ...
  \item[with arity
    ...
    \item[with arity
  \textnormal{$\langle\textit{Rec},\textit{Rec}\rangle$}] --- \{rise \textbf{New!}\}
...
\> Lex$_{\text{CommonNoun}}$(``composer'', composer, \textit{Rec}) \textbf{Revised!},\\
\> Lex$_{\text{CommonNoun}}$(``conductor'', conductor, \textit{Rec}) \textbf{Revised!}, \\
\> Lex$_{\text{CommonNoun}}$(``dog'', dog, \textit{Rec}) \textbf{Revised!}, \\
