...
\begin{ex}
  \begin{tabbing}
exactly\_2000(\=$\ulcorner\lambda r$:\smallrecord{\smalltfield{x}{$\mathrm{plurality}(\textit{PassengerFrame})$}}
...
\item $\mathcal{F}$($\lambda
                                      r$:\smallrecord{\smalltfield{x}{$\mathrm{plurality}(\textit{PassengerFrame})$}})
                                      . \\
\hspace*{5em}\smallrecord{\smalltfield{e}{passenger\_frame\_pl($r$.x)}}) 
 
\item
  \record{\tfield{x}{$\mathrm{plurality}(\textit{PassengerFrame})$}\\
