...
@@\todo{SemBe needs to be revised in the summary.}\todo[inline]{Two similar
  contents and M's intuition that \textit{be} is the same and others
  that different. Coercion.}
...
\item[Frame types] \mbox{}
  ...
  \item[\textnormal{\textit{DogFrame}} New!] --- \smallrecord{\smalltfield{x}{\textit{Ind}}\\
                      \smalltfield{e}{dog(x)}\\
                      \smalltfield{age}{\textit{Real}}\\
                      \smalltfield{c$_{\mathrm{age}}$}{age\_of(x,age)}}
