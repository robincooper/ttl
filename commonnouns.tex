...
\begin{ex} 
If $P$ : (\smallrecord{\smalltfield{x}{$T$}}$\rightarrow$\textit{RecType}) then $\downP{P}$ = $\{a\mid\exists r[r:\text{\smallrecord{\smalltfield{x}{$T$}}}$
$\wedge\ r.\mathrm{x}=a\wedge\down{P(r)}\not=\emptyset]\}$  
\end{ex}

@@\todo{Perhaps \preveg{} should be more general to include restricted properties}
