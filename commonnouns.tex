...
in Lex$_{\mathrm{CommonNoun}}$ in Appendix~\ref{app:lexuniversal}.
...
\begin{ex} 
$\downP{P}$ = $\{a\mid\exists r[r:$\smallrecord{\smalltfield{x}{$P$.bg}}
