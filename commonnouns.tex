...
identical to \nexteg{b}.\todo{Should there be a restriction to $s$ in
...
\item $\mathcal{F}$($\lambda
                                      ...
                                      . \\
\hspace*{5em}\smallrecord{\smallrfield{e}{$s$}{passenger\_frame\_pl($r$.x)}}) 
 
\item
  \record{\tfield{x}{$\mathrm{plurality}(\textit{Rec})$}\\
          \rfield{e}{$s$}{passenger\_frame\_pl(x)}} 
...
\item  ($\lambda
               r$:\smallrecord{\smalltfield{x}{$\mathrm{plurality}(\textit{Rec})$}} . 
                 ...
                 $\!\mid_{\text{\smallrecord{\smalltfield{x}{$\mathrm{plurality}(\textit{Rec})$}\\
          \smallrfield{e}{$s$}{passenger\_frame\_pl(x)}}}}$
