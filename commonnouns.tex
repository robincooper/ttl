...
\hspace*{2em}$\lambda P$:\textit{Ppty} .
\record{\tfield{e}{the(dog$'$$\restriction$$c.\mathfrak{c}$.e, $P$)}} 
 
\item $\lambda
  c$:\smallrecord{
    \smalltfield{$\mathfrak{c}$}{\smallrecord{\smalltfield{e}{unique(dog$'$)}}}} . \\
\hspace*{2em}$\lambda P$:\textit{Ppty} .
\record{\tfield{e}{exist(dog$'$$\restriction$$c.\mathfrak{c}$.e, $P$)}}

\item $\lambda
  c$:\smallrecord{
    \smalltfield{$\mathfrak{c}$}{\smallrecord{\smalltfield{e}{unique(dog$'$)}}}} . \\
\hspace*{2em}$\lambda P$:\textit{Ppty} .
\record{\tfield{e}{every(dog$'$$\restriction$$c.\mathfrak{c}$.e, $P$)}} 
