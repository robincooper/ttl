...
parametric contents associated with some particular phrase? Suppose
that $T$ is a type of parametric contents, that is,
$T\sqsubseteq\textit{Cont}$.  Then we define a new type
...
\item If $T\sqsubseteq\textit{Cont}$, then $\mathfrak{S}(T)$ is a type 
