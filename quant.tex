...
content.  We will add a third component to our contexts will label
`$\mathfrak{w}$' for assignments associated with
\textit{wh}-constructions.  Thus we will redefine the type
\textit{Cntxt} as \nexteg{}.
\begin{ex} 
  \record{
...
. $P$(\smallrecord{\field{x}{$c.\mathfrak{w}$.x$_0$}}))$\urcorner$ 
...
. $P$(\smallrecord{\field{x}{$c.\mathfrak{w}$.x$_0$}}))}}$\urcorner\urcorner$
\end{subex}
\end{ex}
...
.
\begin{ex} 
  \textbf{Sam} = $\ulcorner\lambda c$:\textit{Cntxt}\d{$\wedge$}\smallrecord{
...
and $\beta$ : \smallrecord{\smalltfield{bg}{\textit{CntxtType}}\\
  ...
  \begin{quote}
   $\ulcorner\lambda c$:$[\alpha.\text{bg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{f}}$
      \d{$\wedge$}$\mathrm{incr}_{\mathfrak{s}.\text{x},\mathfrak{w}.\text{x}}([\beta.\text{bg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{a}},\alpha.\text{bg})$
      . \\
      \hspace*{2em}$[\alpha]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{f}}(c)(\mathrm{incr}_{\mathfrak{s}.\text{x},\mathfrak{w}.\text{x}}([\beta.\text{fg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{a}},\alpha.\text{bg})(c))\urcorner$
...
\item
  $\ulcorner\lambda c$:\textit{Cntxt}\d{$\wedge$}\smallrecord{
    \smalltfield{$\mathfrak{w}$}{\smallrecord{
        \smalltfield{x$_0$}{\textit{Ind}}}}\\
    \smalltfield{$\mathfrak{c}$}{\smallrecord{
        \smalltfield{f}{\smallrecord{\footnotesize{\textit{PropCntxt}}\\
            \smalltfield{x}{\textit{Ind}}\\
            \smalltfield{e}{named(x, ``Sam'')}}}}}}
  .
  \smallrecord{\smalltfield{e}{hug($c$.f.x, $\lambda P$:\textit{Ppty} . $P$(\smallrecord{\field{x}{$c.\mathfrak{w}$.x$_0$}}))}}$\urcorner$
