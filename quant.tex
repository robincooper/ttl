...
\item $|X|\geq|\down{\mathfrak{T}(P)}|-\theta_{\text{few}_a}$ 
...
\item $\frac{|X|}{|\down{\mathfrak{T}(P)}|}\geq 1-\theta_{\text{few}_p}$ 
...
This witness condition is given in \nexteg{}.
\begin{ex} 
$s:\text{few}(P,Q)$ iff $s$ :
  \record{\tfield{X}{$\text{many}^w(P)$}\\
          \tfield{f}{$((x:\mathfrak{T}(X))\rightarrow\neg Q\{x\})$}}  
\end{ex} 
...
witness conditions as alternatives. 

@@[Need to revise particular witness
condition to take account of absolute and proportional.  This is not
correct for either absolute or proportional.  Few dogs barked means Not many dogs barked, not Many dogs
didn't bark.]      
