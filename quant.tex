...
\item $\frac{|X|}{|\downP{P}|}\geq\theta_{\text{most}}(P)$, where $.5<\theta_{\text{most}}(P)<1$ 
...
\item $|X|\geq\theta_{\text{many}_a}(P)$, where
  $\theta_{\text{many}_a}(P)$ is a natural number, $i$, such that $i>2$.
...
\item $\frac{|X|}{|\downP{P}|}\geq\theta_{\text{many}_p}(P)$, where $0<\theta_{\text{many}_p}(P)<1$ 
...
\item $\frac{|X|}{|\downP{P}|}\leq\theta_{\text{few}_p}(P)$, where  $0<\theta_{\text{few}_p}(P)<1$
...
\end{description}
   ...
   \subsubsection{Predicates} (as in Chapter~\ref{ch:intensional})
...
\subsubsection{Lexicon} (as in Chapter~\ref{ch:intensional})
% \begin{description}
...
\subsection{English resources} (as in Chapter~\ref{ch:intensional})
