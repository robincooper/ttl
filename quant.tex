...
\todo{Move restrictions on second argument of quantifiers from witness
  conditions to semantics in previous treatments so that it works as
  in the following.  Otherwise donkey binding is difficult...}
