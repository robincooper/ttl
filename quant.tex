...
$[\mathrm{incr}_{\mathfrak{q}.\text{x},\mathfrak{s}.\text{x},\mathfrak{w}.\text{x},\mathfrak{g}.\text{x}}(\alpha,\mathcal{Q}')]_{\mathfrak{c}\leadsto\mathfrak{c}.a}$, then
  ...
  \begin{quote}
    ...
    r$:\smallrecord{
      \smalltfield{x}{\textit{Ind}}\\
      \smalltfield{$\mathfrak{s}$}{\smallrecord{
          \smallmfield{x$_i$}{$\Uparrow$x}{\textit{Ind}}}}}\d{$\wedge$}$\alpha'.\text{bg}^{\mathfrak{s}.\text{x}_i}$
...
\fbox{and $\alpha.\text{bg}\sqsubseteq$ \smallrecord{
  ...
  \begin{quote}
    $\ulcorner\lambda c$:$[\alpha.\text{bg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{f}}$
      \d{$\wedge$}$[\mathrm{incr}_{\mathfrak{s}.\text{x}}([\beta.\text{bg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{a}},\alpha.\text{bg})]_{\boxed{\scriptstyle\mathfrak{s}.\text{x}_j\leadsto\mathfrak{s}.\text{x}_i}}$
      . \\ \hspace*{2em}$[\alpha]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{f}}(c)([\mathrm{incr}_{\mathfrak{s}.\text{x}}([\beta.\text{fg}]_{\mathfrak{c}\leadsto\mathfrak{c}.\text{a}},\alpha.\text{bg})]_{\boxed{\scriptstyle\mathfrak{s}.\text{x}_j\leadsto\mathfrak{s}.\text{x}_i}}(c))\urcorner$
\end{quote}
...
\item $\ulcorner\lambda c$:\smallrecord{
  ...
  . $\lambda r$:\smallrecord{
    \smalltfield{x}{\textit{Ind}}} . 
  \record{\tfield{e}{think($r$.x, fail($c.\mathfrak{s}$.x$_0$)}}$\urcorner$
...
\item $\ulcorner\lambda c$:\smallrecord{
    ...
    \tfield{e}{think($c.\mathfrak{s}.\text{x}_0$, fail($c.\mathfrak{s}.\text{x}_0$))}}$\urcorner$
...
\item $\lambda c$:\smallrecord{
  ...
  \hspace*{2em}($\mathfrak{P}$($\ulcorner\lambda r$:\smallrecord{
    ...
    \tfield{e}{think($r.\mathfrak{s}.\text{x}_0$, \smallrecord{
        \smalltfield{e}{fail($r.\mathfrak{s}.\text{x}_0$)}})}}$\urcorner$)))
...
\item  $\lambda c$:\smallrecord{
  ...
  \hspace*{2em}($\ulcorner\lambda r$:\smallrecord{
    ...
    \tfield{$\mathfrak{c}$}{\record{
        \tfield{$\mathfrak{s}$}{\record{
            \mfield{x$_0$}{$r$.x}{\textit{Ind}}}}}}\\
    \tfield{e}{think($r.\mathfrak{s}.\text{x}_0$, \smallrecord{
        \smalltfield{e}{fail($r.\mathfrak{s}.\text{x}_0$)}})}}$\urcorner$))
  \hfill (purification)

  
\item \hfill ($\beta$-reduction, property restriction)
 
\end{subex} 
   
\end{ex} 

\todo{Fix c.  Fix 'she failed' as argument record type}
