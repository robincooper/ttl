...
context type for the combined phrase.  As record types are labelled
...
p.~\pageref{ex:paths-rectype}).\todo{Perhaps we should be looking at
  total paths of the labelled set rather than of the record type
  (i.e. not going into meets...)}
