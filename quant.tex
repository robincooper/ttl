...
\item \textbf{who}$^\frown$\textbf{Sam}$^\frown$\textbf{hugged} = \\
  \hspace*{1em}$\ulcorner\lambda c$:\textit{Cntxt} . \\
\hspace*{2em}$\ulcorner\lambda
  r_1$:\smallrecord{\smalltfield{x}{\textit{Ind}}}
  . \\
\hspace*{3em}\textbf{who}($c[\mathfrak{w}.\text{x}_0=r_1.\text{x}]$)
($\ulcorner\lambda
  r_2$:\smallrecord{\smalltfield{x}{\textit{Ind}}} . \textbf{Sam}$^\frown$\textbf{hugged}($c[\mathfrak{g}.\text{x}_0=r_2.\text{x}]$)$\urcorner$)$\urcorner\urcorner$ 
...
\item $\ulcorner\lambda c$:\textit{Cntxt} . $\ulcorner\lambda
  r_1$:\smallrecord{\smalltfield{x}{\textit{Ind}}}
  . \smallrecord{\smalltfield{e}{hug$^\dagger$(sam, $r_1$.x))}}$\urcorner\urcorner$ 
 
\end{subex} 
   
\end{ex}

@@\todo[inline]{Pronouns seem to be missing from resource summaries.  Need to
