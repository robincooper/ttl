...
\begin{shaded}
Suppose that $T$ is a record type and that $\pi_1$ and $\pi_2$ are
...
$\pi_1\in\mathrm{paths}(\varphi_1.\text{bg})$ and \\
$\pi_2\in\mathrm{paths}(\mathcal{F}_{\text{quasi}^*}(\varphi_2.\text{fg})$,
then the \textit{content $\varphi_1$ given $\varphi_2$ with
  alignment of $\pi_1$ and $\pi_2$},
$\varphi_1|_{\pi_1,\pi_2}\varphi_2$, is
\begin{quote}
  \record{
    \field{bg}{($\varphi_1$.bg \d{$\wedge$} \smallrecord{
        \smalltfield{$\mathfrak{p}$}{$\mathcal{F}_{\text{quasi}^*}(\varphi_2.\text{fg})$}})$_{\pi_1=\mathfrak{p.\pi_2}}$}\\
...
\item if $\varphi_1:\mathfrak{C}(T_1,T_2)$,
  $\pi_1\in\mathrm{paths}(\varphi_1.\text{bg})$, $\varphi_2:T_2$ and
  $\pi_2\in\mathrm{paths}(\mathcal{F}_{\text{quasi}^*}(\varphi_2.\text{fg}))$,
  then
  \begin{quote}
    $\varphi_1|_{\pi_1,\pi_2}\varphi_2:\mathfrak{C}(T_1,T_2)$
  \end{quote}
