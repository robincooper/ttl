...
\begin{ex} 
  ...
  \item $\beta$.bg $\sqsubseteq$ \smallrecord{
    ...
    $j$,
  \end{enumerate}
  then \textit{the \textit{wh}-combination of $\alpha$ and
...
\end{shaded}
\todo{Introduce slash categories for hug etc. before doing phrase
  structure of wh+S/NP}

@@\todo[inline]{In LexPron we seem to have cnt instead of cont.  Pronouns seem to be missing from resource summaries.
