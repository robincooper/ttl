...
\item $s:q(P,Q)$ iff $s$ :
  \record{\tfield{X}{$q^w(\mathfrak{T}(P))$}\\
          \tfield{f}{$((a:\mathfrak{T}(\text{X}))\rightarrow\mathfrak{P}(Q)\{a\})$}} 
 
\item $s:q(P,Q)$ iff $s$ :
  \record{\tfield{X}{$q^w(\mathfrak{T}(P))$}\\
          \tfield{f}{($(a:(\mathfrak{T}(P)\wedge\mathfrak{T}(\mathfrak{P}(Q))))\rightarrow$
...
\preveg{b}.  Judging from the anaphoric possibilities associated with
natural language quantified expressions the witness conditions used 
are not these but simpler conditions using an equivalent type.  That
...
the witness conditions associated with the individual quantifier relations.    
