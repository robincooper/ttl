...
@@\todo[inline]{Should the types in rules be parametric?  Does
  \textit{PRecType} exist? -- Yes!  In LexPron we seem to have cnt instead of cont.  Pronouns seem to be missing from resource summaries.
