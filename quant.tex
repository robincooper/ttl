...
$p(\mathfrak{T}(X)\|\mathfrak{T}(P))$.  Here we will take a
...
that any person is a stadium is wearing an IFK Göteborg scarf just by
...
seems to point to some kind of Bayesian reasoning about probability as
suggested in \cite{CooperDobnikLappinLarsson2014a} and ????.      
