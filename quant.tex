...
quantifier theory.
\begin{ex} 
$e:q(P,Q)$ iff $q^*$ holds between $\downP{P\restriction e}$ and
$\downP{Q|_{\mathcal{F}(P.\mathrm{fg})}\restriction e}$
\end{ex} 
According to the definitions given in Chapter~\ref{ch:commonnouns},
$\downP{P\restriction e}$ is the set of individuals in $e$ which have
property $P$ and $Q|_{\mathcal{F}(P.\mathrm{fg})}$ is $Q$ with its
...
[@@ Where is $\downP{P\restriction e}$ defined?  Can we spell out what
set the restricted property in the second argument corresponds to?
(p. 12 of notes)]
