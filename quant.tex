...
We will now use
\textbf{no$^\frown$dog$^\frown$which$^\frown$chase$^\frown$a$^\frown$cat}
to refer to \preveg{b} rather than
(\ref{ex:no-dog-which-chases-a-cat}b).  Note that we have not
...
make modifications to the second argument.
