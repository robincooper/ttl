...
%                                                                         . $\lambda
%                                                                         P$:\textit{Ppty}
%                                                                         . $P(\frak{s}.\textrm{x}_0)$(\textit{want}$'$(\textit{a}$'$(\textit{dog}$'$)))}}}} \\
%    \hspace*{5em}                          \smallrecord{\field{quants}{\{\smallrecord{\field{bg}{\smallrecord{\smalltfield{x$_0$}{\textit{Ind}}}} \\
%                                                                           \field{fg}{$\lambda\frak{s}$:\smallrecord{\smalltfield{x$_0$}{\textit{Ind}}}
%                                                                             . \textit{every}$'$(\textit{boy}$'$)}}, \\
%                                                                         \hspace*{1em}\smallrecord{\field{bg}{\smallrecord{\smalltfield{x$_1$}{\textit{Ind}}}} \\
...
%                                                                         . $\lambda
%                                                                         P$:\textit{Ppty}
%                                                                         . $P(\frak{s}.\textrm{x}_0)$(\textit{want}$'$($\lambda P$:\textit{Ppty} .            $P(\frak{s}.\textrm{x}_1)$))}}}} \\
%    \hspace*{5em}                            \smallrecord{\field{quants}{\{\smallrecord{\field{bg}{\smallrecord{\smalltfield{x$_1$}{\textit{Ind}}}} \\
%                                                                           \field{fg}{$\lambda\frak{s}$:\smallrecord{\smalltfield{x$_1$}{\textit{Ind}}}
%                                                                             . \textit{a}$'$(\textit{dog}$'$)}}\}} \\
...
%                                                                       \field{fg}{$\lambda\frak{s}$:\smallrecord{\smalltfield{x$_1$}{\textit{Ind}}}
%                                                                         . \textit{every}$'$(\textit{boy}$'$) \\ 
% \hspace*{1em}($\lambda r$:\smallrecord{\smalltfield{x$_0$}{\textit{Ind}}} . $\lambda P$:\textit{Ppty} . $P$($r$.x$_0$)(\textit{want}$'$($\lambda
%                                                                         P$:\textit{Ppty}
%                                                                         . $P(\frak{s}.\textrm{x}_1)$)})}}}}
%                                                             \\
