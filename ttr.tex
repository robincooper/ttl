...
first replacing all the dependencies on unique identifiers with
appropriate pairs of functions and sequences of paths and then
removing the unique identifiers.  We replace all the dependencies on
...
\item Let $\ell_0.\ldots.\ell_n.\ell\{i\}$ be the path ending in
  ...
  with $\ell_k$ and ending with $\ell\{i\}$, then for each sister,
