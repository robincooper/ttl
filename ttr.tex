...
labelled set (flavoured or unfalvoured) as \textit{labels} used in the labelled set and we will refer to
...
% \todo{Is there a way to avoid this?}These definitions do not in general avoid
