...
\newcommand{\sign}{\includegraphics[width=2in]{/Users/cooper/personal/rhcooper}}
...
\begin{center}
  ...
  \textbf{From perception to communication}

  \textbf{Robin Cooper}

\end{center}

The aim of this book is to characterize a
...
Part~I of the book (Chapters~1--3) deals with a theory of types related to perception
and action and shows a way of presenting a theory of grammar within a
theory of action.  Part~II (Chapters~4--8) then looks at a number of central issues in
...
In Chapter~1 we introduce a notion of perception of an
...
% thing itself'') but only in terms of a type that we assign to it.
We
...
% considerations
.  The overall approach presented here owes much to the
...
In Chapter~2 we introduce some basic notions of a theory of
action based on these types  and apply the theory of types to basic notions of information update in
...
In Chapter~3 we show how syntax and semantics can be
embedded in the theory of action characterized in
Chapters~1 and 2.  Grammatical rules are
...
% compositional interpretation of syntactic structure.
\ignore{We think that
...
% of witnesses. 
The second notion has to do with the facts that the
...
% procedures but to reflect on and reason about them.
  In our terms, an
...
activity.  In Part~II we look at a number of examples of this.


In Chapter~4 we examine reference by uses of proper names and
...
Chapter~2.  % That is, the dialogue participant should
% determine whether there has been reference to somebody of that name
% already in the current dialogue according to her gameboard.
Another place is the visual scene, or more
...
% distinction)
.  This resource is also modelled as a type representing
...
In Chapter~5 we look at frames associated with
...
In Chapter~6 we explore phenomena in natural
...
In Chapter~7 we look at generalized quantifiers from the
...
In Chapter~8 we give an account of how TTR types can be used to talk of
...
% particular content.
We show how earlier ideas about the treatment of
underspecification of quantifier scope and anaphora can be
accommodated in this view.

I have tried to write this book so that it might be accessible to
readers who have a basic knowledge of set theory and logic.  I have
also separated out the technical development by marking it with
shading without compromising the technical detail which is necessary
for a thorough formal development.  In this way I hope that it may be
accessible to graduate students and even in some cases advanced
undergraduates.  The book should be of interest to linguists,
philosophers, psychologists, cognitive scientists and computational
linguists with an interest
in language as action and the formal modelling of cognition and
